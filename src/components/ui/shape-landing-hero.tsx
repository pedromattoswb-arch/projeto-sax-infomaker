          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <motion.div
                ...
                animate="visible"
              >
                <h1 className="text-4xl md:text-6xl lg:text-8xl font-bold mb-6 md:mb-8 tracking-tight">
                  ...
                  <span
                    className={cn(
                      "bg-clip-text text-transparent bg-gradient-to-r from-primary via-blue-400 to-primary/80"
                    )}
                  >
                    {title2}
                  </span>
              ...
              <motion.div
                ...
                animate="visible"
              >
                <p className="text-base md:text-lg lg:text-xl text-white/40 mb-8 md:mb-12 max-w-2xl mx-auto leading-relaxed font-light tracking-wide">
