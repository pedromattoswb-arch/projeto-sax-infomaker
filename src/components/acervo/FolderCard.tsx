...
const FolderCard = React.memo(({ folder, onOpen }: FolderCardProps) => (
  <button
    ...
    className="group flex items-center gap-3 p-3 md:p-5 bg-card border border-border rounded-2xl hover:shadow-lg hover:border-primary/40 active:scale-[0.98] transition-all duration-200 text-left w-full min-h-[60px]"
  >
