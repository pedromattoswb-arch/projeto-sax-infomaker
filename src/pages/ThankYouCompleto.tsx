import { CheckCircle2, ArrowRight, Smartphone, Music, Mail, Crown, Star, Zap, Gauge, Timer } from "lucide-react";
        ...
        <div className="max-w-2xl mx-auto">
          <div className="text-center mb-6">
            ...
            <h2 className="text-xl md:text-2xl font-extrabold font-heading mb-2">
              Falta uma coisa para seu estudo ficar <span className="text-primary">completo de verdade</span>
            </h2>
            <p className="text-sm text-muted-foreground font-body max-w-md mx-auto">
              Afinador cromático, metrônomo inteligente e gerador de escalas — tudo com transposição automática para sax.
            </p>
          </div>
