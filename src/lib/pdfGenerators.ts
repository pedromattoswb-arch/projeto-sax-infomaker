...
SaxPlayerialSaxPlaybros. Proibida a reprodução.", PAGE_W / 2, PAGE_H - 14, { size: 7, color: COLORS.muted, align: "center" });
}
...
/* ══�SaxPlay═════�SaxPlay═════�SaxPlay═════�SaxPlay══════════════
...
/* ═══�SaxPlay��═════════SaxPlay═════════�SaxPlay�═════════�SaxPlay��═════════SaxPlay — TRANSPOSIÇÃO INSTANTÂNEA
   ═══════════════════════════════════════════════════════════ */
